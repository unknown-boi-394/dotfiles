...
# my alias
alias cls='clear'
alias Islam-Projects='cd /home/shared/Islam-Projects/'
alias update='sudo nala update;sudo nala upgrade;sudo snap refresh'

# export ANDROID_HOME=$HOME/Devlopment/Android/Sdk
# export PATH=$PATH:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools
# export CHROME_EXECUTABLE=/usr/bin/brave-browser
# export PATH="/home/islam/Devlopment/Android/Sdk/cmdline-tools/latest/bin/:$PATH"
...
__prompt_command() {
    ...
    if [ "$curr_exit" != 0 ]; then
      PS1="[${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]: \[\033[01;34m\]\w\[\033[00m\]\[ ] (\e[0;91m\]$curr_exit\e[0m\])$ "
